...
export default function ListenAgainMore() {
  ...
  const {
    ...
    enterNavFromGrid,
    enterContent,
  } = useTvGridScreenFocus("more-listen-again", gridLayout.columns);
  ...
  return (
    <div ref={shellRef} className="tv-drill-screen tv-screen-overlay">
      ...
      >
        ...
        >
          {tiles.length === 0 ? (
            <p className="tv-drill-screen__empty">
              Nothing in your listening history yet.
            </p>
          ) : (
            <ContentGrid
              ref={gridRef}
