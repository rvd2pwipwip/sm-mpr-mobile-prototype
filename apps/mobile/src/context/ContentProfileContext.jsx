...
/**
 * Prototype: which content types (music / podcasts / radio) are enabled.
 * Default music-only; **Full MPR** on `/upgrade` restores all types for internal review.
 */
  ...
  const value = useMemo(
    () => ({
      ...
      filterListenHistory: (items) =>
        filterListenHistoryByProfile(items, enabledContentTypes),
      isMusicOnlyProfile:
