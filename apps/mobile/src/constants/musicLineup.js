 ...
 * - `broad` ≈ 1000+ territories (top-level **vibes**: Genre / Activity / Mood / Era / Theme in UI; subcategories are **tags** — see `docs/mobile/Stories/Search-story.md` Integration notes).
 *
