...
- [x] **Podcasts Phase 0–4** — shared state, routes, `PodcastInfo`, episode UI, full `PodcastPlayer` (Figma `7531:342033`); see [`Podcasts-implementation-plan.md`](./Podcasts-implementation-plan.md)

---

## Next steps (ordered)

1. **Podcasts on TV Phases 5–7** — mini player for podcasts, browse library rows; see [`Podcasts-implementation-plan.md`](./Podcasts-implementation-plan.md)
